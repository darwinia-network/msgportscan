...
ActiveRecord::Schema[7.1].define(version: 2023_12_21_092252) do
  ...
  create_table "pug_ormp_line_ext_ownership_transfer_starteds", force: :cascade do |t|
    t.bigint "pug_evm_log_id", null: false
    t.bigint "pug_evm_contract_id", null: false
    t.bigint "pug_network_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pug_evm_contract_id"], name: "idx_on_pug_evm_contract_id_e78c3a025a"
    t.index ["pug_evm_log_id"], name: "idx_on_pug_evm_log_id_e4399865ce"
    t.index ["pug_network_id", "block_number", "transaction_index", "log_index"], name: "idx_on_pug_network_id_block_number_transaction_inde_51c010ce3f", unique: true
    t.index ["pug_network_id", "new_owner"], name: "idx_on_pug_network_id_new_owner_ae59fcf20c"
    t.index ["pug_network_id", "previous_owner"], name: "idx_on_pug_network_id_previous_owner_0c7f20838e"
    t.index ["pug_network_id"], name: "idx_on_pug_network_id_39e2ba2e83"
  end

  create_table "pug_ormp_line_ext_ownership_transferreds", force: :cascade do |t|
    t.bigint "pug_evm_log_id", null: false
    t.bigint "pug_evm_contract_id", null: false
    t.bigint "pug_network_id", null: false
    t.string "previous_owner"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pug_evm_contract_id"], name: "idx_on_pug_evm_contract_id_15faa79771"
    t.index ["pug_evm_log_id"], name: "idx_on_pug_evm_log_id_22be11b75a"
    t.index ["pug_network_id", "block_number", "transaction_index", "log_index"], name: "idx_on_pug_network_id_block_number_transaction_inde_97a859e191", unique: true
    t.index ["pug_network_id", "new_owner"], name: "idx_on_pug_network_id_new_owner_1466792d23"
    t.index ["pug_network_id", "previous_owner"], name: "idx_on_pug_network_id_previous_owner_008230488b"
    t.index ["pug_network_id"], name: "idx_on_pug_network_id_a0a729407c"
  end

  create_table "pug_ormp_line_ext_set_from_lines", force: :cascade do |t|
    t.bigint "pug_evm_log_id", null: false
    t.bigint "pug_evm_contract_id", null: false
    t.bigint "pug_network_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pug_evm_contract_id"], name: "index_pug_ormp_line_ext_set_from_lines_on_pug_evm_contract_id"
    t.index ["pug_evm_log_id"], name: "index_pug_ormp_line_ext_set_from_lines_on_pug_evm_log_id"
    t.index ["pug_network_id", "block_number", "transaction_index", "log_index"], name: "idx_on_pug_network_id_block_number_transaction_inde_d04b6151cf", unique: true
    t.index ["pug_network_id", "from_chain_id"], name: "idx_on_pug_network_id_from_chain_id_cca39e793c"
    t.index ["pug_network_id", "from_line"], name: "idx_on_pug_network_id_from_line_c8cfbe4318"
    t.index ["pug_network_id"], name: "index_pug_ormp_line_ext_set_from_lines_on_pug_network_id"
  end

  create_table "pug_ormp_line_ext_set_to_lines", force: :cascade do |t|
    t.bigint "pug_evm_log_id", null: false
    t.bigint "pug_evm_contract_id", null: false
    t.bigint "pug_network_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pug_evm_contract_id"], name: "index_pug_ormp_line_ext_set_to_lines_on_pug_evm_contract_id"
    t.index ["pug_evm_log_id"], name: "index_pug_ormp_line_ext_set_to_lines_on_pug_evm_log_id"
    t.index ["pug_network_id", "block_number", "transaction_index", "log_index"], name: "idx_on_pug_network_id_block_number_transaction_inde_0b6716e7af", unique: true
    t.index ["pug_network_id", "to_chain_id"], name: "idx_on_pug_network_id_to_chain_id_742c5b61ee"
    t.index ["pug_network_id", "to_line"], name: "idx_on_pug_network_id_to_line_7145ba68ff"
    t.index ["pug_network_id"], name: "index_pug_ormp_line_ext_set_to_lines_on_pug_network_id"
  end

  create_table "pug_ormp_line_ext_uris", force: :cascade do |t|
    t.bigint "pug_evm_log_id", null: false
    t.bigint "pug_evm_contract_id", null: false
    t.bigint "pug_network_id", null: false
    t.string "uri"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pug_evm_contract_id"], name: "index_pug_ormp_line_ext_uris_on_pug_evm_contract_id"
    t.index ["pug_evm_log_id"], name: "index_pug_ormp_line_ext_uris_on_pug_evm_log_id"
    t.index ["pug_network_id", "block_number", "transaction_index", "log_index"], name: "idx_on_pug_network_id_block_number_transaction_inde_d61925e63a", unique: true
    t.index ["pug_network_id", "uri"], name: "index_pug_ormp_line_ext_uris_on_pug_network_id_and_uri"
    t.index ["pug_network_id"], name: "index_pug_ormp_line_ext_uris_on_pug_network_id"
  end
  ...
  create_table "pug_sub_api_add_beacons", force: :cascade do |t|
    ...
    t.decimal "chain_id", precision: 78
    t.string "beacon_id"
    t.decimal "beacon_chain_id", precision: 78
    ...
    t.index ["pug_network_id", "beacon_chain_id"], name: "idx_on_pug_network_id_beacon_chain_id_69796e9c87"
    ...
    t.index ["pug_network_id", "chain_id"], name: "index_pug_sub_api_add_beacons_on_pug_network_id_and_chain_id"
  ...
  create_table "pug_sub_api_aggregated_ormp_data", force: :cascade do |t|
    ...
    t.index ["pug_network_id", "chain_id"], name: "idx_on_pug_network_id_chain_id_9ffd1536d4"
  ...
  create_table "pug_sub_api_airnode_rrp_requesteds", force: :cascade do |t|
    ...
    t.index ["pug_network_id", "chain_id"], name: "idx_on_pug_network_id_chain_id_f3eb93f2c6"
  ...
  create_table "pug_sub_api_remove_beacons", force: :cascade do |t|
    ...
    t.index ["pug_network_id", "chain_id"], name: "idx_on_pug_network_id_chain_id_4c67629c59"
  ...
  add_foreign_key "pug_ormp_line_ext_ownership_transfer_starteds", "pug_evm_contracts"
  add_foreign_key "pug_ormp_line_ext_ownership_transfer_starteds", "pug_evm_logs"
  add_foreign_key "pug_ormp_line_ext_ownership_transfer_starteds", "pug_networks"
  add_foreign_key "pug_ormp_line_ext_ownership_transferreds", "pug_evm_contracts"
  add_foreign_key "pug_ormp_line_ext_ownership_transferreds", "pug_evm_logs"
  add_foreign_key "pug_ormp_line_ext_ownership_transferreds", "pug_networks"
  add_foreign_key "pug_ormp_line_ext_set_from_lines", "pug_evm_contracts"
  add_foreign_key "pug_ormp_line_ext_set_from_lines", "pug_evm_logs"
  add_foreign_key "pug_ormp_line_ext_set_from_lines", "pug_networks"
  add_foreign_key "pug_ormp_line_ext_set_to_lines", "pug_evm_contracts"
  add_foreign_key "pug_ormp_line_ext_set_to_lines", "pug_evm_logs"
  add_foreign_key "pug_ormp_line_ext_set_to_lines", "pug_networks"
  add_foreign_key "pug_ormp_line_ext_uris", "pug_evm_contracts"
  add_foreign_key "pug_ormp_line_ext_uris", "pug_evm_logs"
  add_foreign_key "pug_ormp_line_ext_uris", "pug_networks"
