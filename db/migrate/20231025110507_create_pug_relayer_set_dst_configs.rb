class CreatePugRelayerSetDstConfigs < ActiveRecord::Migration[7.1]
  def change
    create_table :pug_relayer_set_dst_configs do |t|
      ...
      t.decimal :e_base_gas, precision: 20, scale: 0
      t.decimal :e_gas_per_byte, precision: 20, scale: 0

      t.timestamps
    end
    add_index :pug_relayer_set_dst_configs, :e_chain_id
    add_index :pug_relayer_set_dst_configs, :e_base_gas
    add_index :pug_relayer_set_dst_configs, :e_gas_per_byte
  end
end
