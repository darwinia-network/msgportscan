class CreatePugSubApiAggregatedOrmpData < ActiveRecord::Migration[7.1]
  def change
    create_table :pug_sub_api_aggregated_ormp_data do |t|
      ...
      t.decimal :e_ormp_data_count, precision: 78, scale: 0
      t.string :e_ormp_data_root

      t.timestamps
    end
    add_index :pug_sub_api_aggregated_ormp_data, :e_ormp_data_count
    add_index :pug_sub_api_aggregated_ormp_data, :e_ormp_data_root
  end
end
