class CreatePugOracleAssigneds < ActiveRecord::Migration[7.1]
  def change
    ...
    add_index :pug_oracle_assigneds, [:pug_network_id, :msg_hash]
    add_index :pug_oracle_assigneds, [:pug_network_id, :fee]
    add_index :pug_oracle_assigneds, %i[pug_network_id block_number transaction_index log_index], unique: true
  end
end
