class CreatePugOracleSetFees < ActiveRecord::Migration[7.1]
  def change
    ...
    add_index :pug_oracle_set_fees, [:pug_network_id, :chain_id]
    add_index :pug_oracle_set_fees, [:pug_network_id, :fee]
    add_index :pug_oracle_set_fees, %i[pug_network_id block_number transaction_index log_index], unique: true
  end
end
